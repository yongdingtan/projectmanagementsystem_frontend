    ...
    <div className="sticky">
      <div className="border rounded-lg">
        ...
        <div className="relative p-0">
          <Input placeHolder="type message" className="py-7 border-t outline-none focus:outline-none focus:ring-0 rounded-none border-b-0 border-x-0"
